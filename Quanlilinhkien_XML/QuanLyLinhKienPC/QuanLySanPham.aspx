...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <a href="ThemSuaSanPham.aspx" class="btn btn-primary fw-bold shadow-sm d-flex align-items-center">
        <i class="fas fa-plus"></i> 
        <span class="d-none d-lg-inline ms-2">Nhập Kho</span>
    </a>

    <div class="dropdown">
        <button class="btn btn-outline-primary fw-bold dropdown-toggle shadow-sm d-flex align-items-center" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="fas fa-download"></i> 
            <span class="d-none d-lg-inline ms-2">Xuất Dữ Liệu</span>
        </button>
        <ul class="dropdown-menu shadow border-0" aria-labelledby="dropdownMenuButton1">
            <li>
                <asp:LinkButton ID="btnExportXML" runat="server" OnClick="btnExportXML_Click" CssClass="dropdown-item py-2">
                    <i class="fas fa-code me-2 text-warning"></i>Chuyển đổi SQL sang XML
                </asp:LinkButton>
            </li>
            <li><hr class="dropdown-divider"></li>
            <li>
                <asp:LinkButton ID="btnExportSQL" runat="server" OnClick="btnExportSQL_Click" CssClass="dropdown-item py-2">
                    <i class="fas fa-database me-2 text-primary"></i> Script SQL Server
                </asp:LinkButton>
            </li>
            <li>
                <asp:LinkButton ID="btnExportMySQL" runat="server" OnClick="btnExportMySQL_Click" CssClass="dropdown-item py-2">
    ...
    <button type="button" class="btn btn-outline-secondary fw-bold shadow-sm d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#importModal" title="Chuyển đổi XML sang SQL">
        <i class="fas fa-file-import"></i> 
        <span class="d-none d-xl-inline ms-2">Chuyển đổi XML sang SQL</span>
    </button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:DropDownList ID="ddlImportType" runat="server" CssClass="form-select">
                                <asp:ListItem Value="XML" Selected="True">Chuyển đổi từ File XML (XML Data)</asp:ListItem>
                    ...
                    <div class="modal-footer bg-light">
                        ...
                        <asp:Button ID="btnImportData" runat="server" Text="Tiến Hành chuyển đổi file"
